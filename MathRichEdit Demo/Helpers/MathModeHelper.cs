...
/// <summary>
/// Provides utility methods to support math mode in a RichEditBox control.
/// </summary>
/// <remarks>
/// This helper class supplies collections of common mathematical symbols and structured math expressions
/// (fractions, integrals, large operators, matrices, etc.) grouped by category.
/// These collections can be used to populate symbol palettes, toolbars, or autocomplete features
/// in math-aware editors or custom RichEditBox implementations targeting math input.
/// </remarks>
static class MathModeHelper
{
    /// <summary>
